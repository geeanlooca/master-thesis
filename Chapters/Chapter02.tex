...
In this chapter, the basic theoretical background needed to comprehend the working mechanisms behind the OCT technique are reported, the different schemes are introduced and compared in terms of performance. The content of this chapter is partially adapted from Refs. \cite{Midrio2006,Someda2006,Wolf1999}. 
